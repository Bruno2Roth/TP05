...
namespace TP05.Models
{
    public class Escape
    {
        ...
        public Escape(string nJ)
        {
            ...
            this.secuencias = new List<SecuenciaSala1> {
            new SecuenciaSala1(new List<string> { "2", "3", "5", "7", "11", "13" }, 1),
            new SecuenciaSala1(new List<string> { "0", "1", "4", "9", "16", "25" }, 1),
            new SecuenciaSala1(new List<string> { "1", "2", "6", "24", "120", "720" }, 1),
            ...
            this.simon.respuestas = this.simon.generarSecuencia();
        }
